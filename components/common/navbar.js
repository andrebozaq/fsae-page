...
export default function Navbar() {
    ...
    return (
        <header
            className={`w-full relative z-50 bg-base-100 p-5 pb-0 md:mb-5 flex justify-between items-center sticky top-0 left-0 right-0 shadow-md transition-transform duration-300 ${showNavbar ? 'translate-y-0' : '-translate-y-full'}`}
        >
            <a
